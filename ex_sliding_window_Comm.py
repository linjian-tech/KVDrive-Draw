...
N = 5
# memory_size = [19.34, 7, 4, 2.3, 1.28] 
memory_size = np.array([0.61, 0.25, 0.14, 0.056, 0.035])/35*23*1000
memory_size[0] = 402
memory_size = memory_size * 8 / 196 
...
p1 = plt.bar(ind, memory_size, width, color='none', edgecolor=color_2, hatch="-----", alpha=.99, label='Communication Size')
...
# plt.legend(p1[0], 'Communication Size', loc="upper left")
# ax1.set_ylim((0, 10))
...
plt.savefig("figure/ex_sliding_window_Comm.pdf", format = 'pdf', bbox_inches='tight')
