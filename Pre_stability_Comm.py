...
N = 4
comm_size = np.array([0.04, 0.033, 0.043, 0.035]) / 0.035 * 0.023 * 1000
...
p1 = plt.bar(ind, comm_size, width, color='none', edgecolor=color_2, hatch="-----", alpha=.99)
...
plt.tight_layout() 
plt.savefig("figure/Pre_stability_Comm.pdf", format = 'pdf', bbox_inches='tight')
